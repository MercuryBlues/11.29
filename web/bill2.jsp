            ...
            <c:forEach items="${pageInfo.list}" var="book">
                <tr>
                    ...
                    <td><a href="/lend.action?bookId=${book.id}"><em>
                        <c:if test="${book.bookId==null}"><input name="jieyue" type="button" value="借阅"
                                                              class="input-button"></c:if>
                        <c:if test="${book.bookId!=null}"><input type="button" value="借阅" class="input-button-disabled"
                                                              disabled></c:if>
                    </em></a></td>
                </tr>
            </c:forEach>
