		...
		<div class="content">
			<table class="box">
			   <tbody><tr>
					...
					<td><input type="text" name="name" class="text" id="name" value=""> <span></span><font color="red">*</font><font color="red" id="name_span"></font></td>
				</tr>
				 <tr>
...
$(function () {
	...
	name.blur(function () {
		$.ajax({
			url:<%=request.getContextPath()%>"/checkName.action",
			data:"name="+name.val(),
			success:function (d) {
				$("span").html(d);
            }
